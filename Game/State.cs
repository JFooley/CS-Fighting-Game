...
public class State {
    ...
    public State(List<FrameData> frames, string post_state, int framerate = 30, int priority = -1, bool loop = true, bool changeOnLastframe = true, bool changeOnGround = false, bool doTrace = false, string[] hitstop = null) {
    ...
    public State(List<string> frames, string post_state, int framerate = 30, int priority = -1, bool changeOnLastframe = true, bool changeOnGround = false, bool doTrace = false, string[] hitstop = null) {
