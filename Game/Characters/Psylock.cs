...
public class Psylock : Character {
    public Psylock(string initialState, int startX, int startY)
        : base("Psylock", initialState, startX, startY, "D:/GABRIEL/Repositórios/Fighting Game CS/Game/Assets/chars/Psylock", "D:/GABRIEL/Repositórios/Fighting Game CS/Game/Assets/sounds/Psylock")
    {
    ...
    public override void Load() {
        ...
        var walkingForwardFrames = new List<FrameData> {
            new FrameData(60, 7, 0, new List<GenericBox> { new GenericBox(2, 88, 179, 154, 194), new GenericBox(1, 117, 87, 140, 104), new GenericBox(1, 140, 102, 164, 118), new GenericBox(1, 102, 104, 143, 179) }),
            new FrameData(61, 7, 0, new List<GenericBox> { new GenericBox(1, 102, 103, 141, 194), new GenericBox(1, 117, 88, 141, 104), new GenericBox(1, 138, 103, 163, 117), new GenericBox(2, 95, 180, 151, 195) }),
            new FrameData(62, 7, 0, new List<GenericBox> { new GenericBox(2, 96, 181, 145, 195), new GenericBox(1, 116, 86, 141, 104), new GenericBox(1, 102, 98, 138, 194), new GenericBox(1, 138, 102, 162, 116) }),
            new FrameData(63, 7, 0, new List<GenericBox> { new GenericBox(1, 117, 85, 140, 103), new GenericBox(1, 104, 99, 137, 194), new GenericBox(1, 135, 102, 162, 116), new GenericBox(2, 98, 183, 142, 194) }),
            new FrameData(64, 7, 0, new List<GenericBox> { new GenericBox(2, 96, 180, 145, 194), new GenericBox(1, 118, 87, 140, 104), new GenericBox(1, 105, 101, 139, 193), new GenericBox(1, 137, 104, 164, 118) }),
            new FrameData(65, 7, 0, new List<GenericBox> { new GenericBox(1, 118, 87, 139, 103), new GenericBox(1, 105, 102, 141, 195), new GenericBox(1, 135, 103, 162, 118), new GenericBox(2, 96, 180, 150, 195) }),
            new FrameData(66, 7, 0, new List<GenericBox> { new GenericBox(1, 117, 89, 139, 104), new GenericBox(1, 104, 104, 145, 194), new GenericBox(1, 138, 106, 164, 119), new GenericBox(2, 96, 179, 152, 195) }),
            new FrameData(67, 7, 0, new List<GenericBox> { new GenericBox(2, 94, 180, 154, 195), new GenericBox(1, 118, 89, 138, 105), new GenericBox(1, 95, 106, 112, 119), new GenericBox(1, 106, 103, 138, 145), new GenericBox(1, 98, 146, 147, 195), new GenericBox(1, 138, 106, 163, 119) }),
            new FrameData(68, 7, 0, new List<GenericBox> { new GenericBox(1, 117, 91, 137, 107), new GenericBox(1, 95, 107, 161, 124), new GenericBox(1, 106, 123, 135, 163), new GenericBox(1, 95, 163, 152, 194), new GenericBox(2, 93, 178, 155, 195) }),
            new FrameData(69, 7, 0, new List<GenericBox> { new GenericBox(2, 88, 178, 151, 194), new GenericBox(1, 119, 91, 138, 107), new GenericBox(1, 95, 107, 164, 123), new GenericBox(1, 105, 122, 135, 153), new GenericBox(1, 93, 154, 147, 194) }),
            new FrameData(70, 7, 0, new List<GenericBox> { new GenericBox(1, 119, 93, 138, 109), new GenericBox(1, 95, 108, 163, 123), new GenericBox(1, 106, 123, 134, 163), new GenericBox(1, 88, 163, 144, 194), new GenericBox(2, 86, 176, 146, 194) }),
            new FrameData(71, 7, 0, new List<GenericBox> { new GenericBox(2, 82, 177, 143, 195), new GenericBox(1, 118, 92, 140, 109), new GenericBox(1, 96, 106, 163, 125), new GenericBox(1, 103, 123, 132, 164), new GenericBox(1, 85, 163, 141, 194) }),
            new FrameData(72, 7, 0, new List<GenericBox> { new GenericBox(1, 118, 94, 138, 110), new GenericBox(1, 95, 109, 163, 124), new GenericBox(1, 105, 123, 133, 156), new GenericBox(1, 83, 156, 135, 194), new GenericBox(2, 81, 179, 140, 195) }),
            new FrameData(73, 7, 0, new List<GenericBox> { new GenericBox(2, 79, 177, 144, 195), new GenericBox(1, 117, 94, 138, 109), new GenericBox(1, 95, 108, 162, 123), new GenericBox(1, 104, 123, 133, 157), new GenericBox(1, 81, 157, 135, 194) }),
            new FrameData(74, 7, 0, new List<GenericBox> { new GenericBox(1, 119, 89, 138, 104), new GenericBox(1, 96, 102, 162, 120), new GenericBox(1, 104, 121, 136, 195), new GenericBox(2, 96, 178, 151, 195) }),
            new FrameData(75, 7, 0, new List<GenericBox> { new GenericBox(2, 99, 176, 144, 194), new GenericBox(1, 97, 101, 163, 118), new GenericBox(1, 117, 88, 139, 105), new GenericBox(1, 102, 119, 137, 195) }),
            new FrameData(76, 7, 0, new List<GenericBox> { new GenericBox(1, 117, 87, 139, 102), new GenericBox(1, 102, 100, 138, 195), new GenericBox(1, 136, 101, 160, 115), new GenericBox(2, 93, 179, 147, 194) }),
            new FrameData(77, 7, 0, new List<GenericBox> { new GenericBox(2, 95, 180, 147, 195), new GenericBox(1, 117, 89, 138, 102), new GenericBox(1, 98, 100, 142, 195), new GenericBox(1, 136, 103, 162, 116) }),
            new FrameData(78, 7, 0, new List<GenericBox> { new GenericBox(1, 119, 89, 138, 102), new GenericBox(1, 100, 102, 138, 141), new GenericBox(1, 136, 105, 159, 119), new GenericBox(1, 99, 139, 142, 194), new GenericBox(2, 98, 183, 145, 194) }),
            new FrameData(79, 7, 0, new List<GenericBox> { new GenericBox(2, 95, 180, 149, 194), new GenericBox(1, 116, 88, 139, 103), new GenericBox(1, 101, 101, 139, 142), new GenericBox(1, 138, 105, 161, 120), new GenericBox(1, 100, 139, 145, 194) }),
            new FrameData(80, 7, 0, new List<GenericBox> { new GenericBox(1, 118, 90, 138, 105), new GenericBox(1, 98, 104, 139, 142), new GenericBox(1, 138, 106, 162, 120), new GenericBox(1, 98, 142, 151, 195), new GenericBox(2, 95, 181, 155, 194) }),
            new FrameData(81, 7, 0, new List<GenericBox> { new GenericBox(2, 90, 181, 163, 195), new GenericBox(1, 118, 90, 140, 104), new GenericBox(1, 99, 103, 158, 120), new GenericBox(1, 101, 120, 137, 143), new GenericBox(1, 93, 143, 155, 195) }),
            new FrameData(82, 7, 0, new List<GenericBox> { new GenericBox(1, 116, 92, 139, 105), new GenericBox(1, 107, 108, 138, 149), new GenericBox(1, 97, 110, 158, 125), new GenericBox(1, 91, 144, 158, 194), new GenericBox(2, 88, 174, 166, 194) }),
            new FrameData(83, 7, 0, new List<GenericBox> { new GenericBox(2, 84, 180, 163, 194), new GenericBox(1, 118, 92, 138, 107), new GenericBox(1, 106, 106, 138, 145), new GenericBox(1, 96, 109, 157, 126), new GenericBox(1, 89, 145, 155, 194) }),
            new FrameData(84, 7, 0, new List<GenericBox> { new GenericBox(1, 84, 149, 151, 193), new GenericBox(1, 103, 127, 135, 151), new GenericBox(1, 106, 107, 138, 127), new GenericBox(1, 120, 92, 137, 108), new GenericBox(1, 136, 111, 157, 125), new GenericBox(2, 77, 178, 159, 195) }),
            new FrameData(85, 7, 0, new List<GenericBox> { new GenericBox(1, 118, 93, 138, 107), new GenericBox(1, 107, 107, 139, 148), new GenericBox(1, 96, 109, 157, 127), new GenericBox(1, 82, 146, 151, 194), new GenericBox(2, 74, 182, 155, 195) }),
            new FrameData(86, 7, 0, new List<GenericBox> { new GenericBox(2, 68, 183, 150, 195), new GenericBox(1, 120, 93, 139, 110), new GenericBox(1, 106, 107, 139, 148), new GenericBox(1, 98, 111, 158, 128), new GenericBox(1, 74, 149, 151, 195) }),
            new FrameData(87, 7, 0, new List<GenericBox> { new GenericBox(1, 117, 93, 138, 109), new GenericBox(1, 107, 107, 138, 147), new GenericBox(1, 97, 110, 156, 127), new GenericBox(1, 73, 148, 151, 193), new GenericBox(2, 65, 182, 152, 195) }),
        };

        var walkingBackwardFrames = new List<FrameData> {
            new FrameData(88, -7, 0, new List<GenericBox> { new GenericBox(2, 95, 180, 152, 194), new GenericBox(1, 115, 87, 132, 102), new GenericBox(1, 100, 102, 144, 193), new GenericBox(1, 139, 109, 151, 133) }),
            new FrameData(89, -7, 0, new List<GenericBox> { new GenericBox(1, 112, 86, 131, 103), new GenericBox(1, 100, 103, 143, 194), new GenericBox(1, 138, 109, 151, 132), new GenericBox(2, 97, 179, 149, 194) }),
            new FrameData(90, -7, 0, new List<GenericBox> { new GenericBox(2, 98, 179, 143, 194), new GenericBox(1, 113, 86, 133, 102), new GenericBox(1, 102, 101, 139, 195), new GenericBox(1, 137, 105, 153, 132) }),
            new FrameData(91, -7, 0, new List<GenericBox> { new GenericBox(1, 113, 87, 134, 101), new GenericBox(1, 103, 100, 139, 194), new GenericBox(1, 137, 105, 152, 132), new GenericBox(2, 100, 180, 146, 194) }),
            new FrameData(92, -7, 0, new List<GenericBox> { new GenericBox(2, 97, 179, 143, 195), new GenericBox(1, 113, 88, 132, 103), new GenericBox(1, 103, 101, 137, 195), new GenericBox(1, 137, 106, 154, 134) }),
            new FrameData(93, -7, 0, new List<GenericBox> { new GenericBox(1, 113, 87, 133, 102), new GenericBox(1, 105, 101, 138, 194), new GenericBox(1, 138, 108, 154, 133), new GenericBox(2, 100, 181, 145, 194) }),
            new FrameData(94, -7, 0, new List<GenericBox> { new GenericBox(2, 95, 179, 146, 194), new GenericBox(1, 114, 88, 133, 103), new GenericBox(1, 102, 103, 139, 147), new GenericBox(1, 99, 148, 136, 194), new GenericBox(1, 138, 107, 155, 134) }),
            new FrameData(95, -7, 0, new List<GenericBox> { new GenericBox(1, 116, 89, 133, 104), new GenericBox(1, 104, 103, 137, 148), new GenericBox(1, 136, 107, 154, 133), new GenericBox(1, 96, 150, 142, 194), new GenericBox(2, 92, 181, 145, 194) }),
            new FrameData(96, -7, 0, new List<GenericBox> { new GenericBox(2, 89, 180, 149, 197), new GenericBox(1, 115, 92, 134, 108), new GenericBox(1, 105, 107, 138, 151), new GenericBox(1, 134, 112, 156, 140), new GenericBox(1, 93, 152, 145, 194) }),
            new FrameData(97, -7, 0, new List<GenericBox> { new GenericBox(1, 114, 91, 132, 107), new GenericBox(1, 104, 106, 138, 160), new GenericBox(1, 135, 114, 155, 139), new GenericBox(1, 94, 160, 147, 195), new GenericBox(2, 92, 178, 153, 195) }),
            new FrameData(98, -7, 0, new List<GenericBox> { new GenericBox(2, 95, 176, 157, 194), new GenericBox(1, 113, 93, 134, 108), new GenericBox(1, 106, 106, 139, 162), new GenericBox(1, 137, 111, 157, 138), new GenericBox(1, 98, 162, 153, 194) }),
            new FrameData(99, -7, 0, new List<GenericBox> { new GenericBox(1, 113, 91, 133, 109), new GenericBox(1, 104, 108, 139, 156), new GenericBox(1, 138, 114, 156, 138), new GenericBox(1, 99, 155, 155, 194), new GenericBox(2, 99, 180, 161, 195) }),
            new FrameData(100, -7, 0, new List<GenericBox> { new GenericBox(2, 103, 179, 161, 194), new GenericBox(1, 114, 92, 134, 109), new GenericBox(1, 105, 109, 140, 163), new GenericBox(1, 139, 115, 156, 139), new GenericBox(1, 103, 162, 154, 193) }),
            new FrameData(101, -7, 0, new List<GenericBox> { new GenericBox(1, 109, 164, 158, 194), new GenericBox(1, 109, 108, 142, 165), new GenericBox(1, 97, 110, 110, 125), new GenericBox(1, 132, 115, 158, 140), new GenericBox(1, 114, 93, 134, 109), new GenericBox(2, 105, 177, 165, 194) }),
            new FrameData(102, -7, 0, new List<GenericBox> { new GenericBox(2, 100, 177, 148, 195), new GenericBox(1, 107, 101, 141, 195), new GenericBox(1, 96, 105, 155, 132), new GenericBox(1, 114, 87, 133, 102) }),
            new FrameData(103, -7, 0, new List<GenericBox> { new GenericBox(1, 115, 88, 132, 102), new GenericBox(2, 100, 181, 143, 194), new GenericBox(1, 105, 102, 140, 195), new GenericBox(1, 97, 106, 155, 134) }),
            new FrameData(104, -7, 0, new List<GenericBox> { new GenericBox(1, 105, 100, 141, 160), new GenericBox(1, 105, 159, 137, 194), new GenericBox(1, 139, 105, 154, 131), new GenericBox(1, 96, 101, 108, 111), new GenericBox(1, 114, 86, 133, 101) }),
            new FrameData(105, -7, 0, new List<GenericBox> { new GenericBox(1, 115, 87, 133, 101), new GenericBox(1, 106, 100, 137, 140), new GenericBox(1, 95, 101, 152, 131), new GenericBox(1, 104, 131, 141, 194), new GenericBox(2, 98, 181, 149, 195) }),
            new FrameData(106, -7, 0, new List<GenericBox> { new GenericBox(2, 95, 179, 146, 195), new GenericBox(1, 114, 87, 134, 102), new GenericBox(1, 105, 101, 150, 134), new GenericBox(1, 100, 132, 143, 195) }),
            new FrameData(107, -7, 0, new List<GenericBox> { new GenericBox(1, 106, 101, 138, 141), new GenericBox(1, 114, 88, 132, 101), new GenericBox(1, 134, 106, 151, 133), new GenericBox(1, 96, 139, 142, 194), new GenericBox(2, 92, 179, 145, 196) }),
            new FrameData(108, -7, 0, new List<GenericBox> { new GenericBox(2, 88, 177, 147, 195), new GenericBox(1, 90, 147, 145, 194), new GenericBox(1, 105, 102, 138, 147), new GenericBox(1, 135, 109, 151, 134), new GenericBox(1, 113, 88, 135, 104) }),
            new FrameData(109, -7, 0, new List<GenericBox> { new GenericBox(1, 114, 89, 133, 104), new GenericBox(1, 105, 102, 137, 143), new GenericBox(1, 135, 108, 150, 134), new GenericBox(1, 88, 143, 146, 194), new GenericBox(2, 81, 178, 151, 195) }),
            new FrameData(110, -7, 0, new List<GenericBox> { new GenericBox(1, 115, 91, 131, 106), new GenericBox(1, 103, 108, 139, 145), new GenericBox(1, 136, 116, 148, 140), new GenericBox(1, 81, 145, 151, 194), new GenericBox(2, 77, 177, 155, 195) }),
            new FrameData(111, -7, 0, new List<GenericBox> { new GenericBox(2, 81, 176, 160, 194), new GenericBox(1, 114, 91, 133, 106), new GenericBox(1, 101, 106, 147, 147), new GenericBox(1, 85, 145, 156, 194) }),
            new FrameData(112, -7, 0, new List<GenericBox> { new GenericBox(1, 113, 92, 133, 109), new GenericBox(1, 103, 107, 141, 148), new GenericBox(1, 138, 114, 150, 139), new GenericBox(1, 87, 145, 159, 194), new GenericBox(2, 83, 175, 164, 194) }),
            new FrameData(113, -7, 0, new List<GenericBox> { new GenericBox(2, 88, 174, 170, 195), new GenericBox(1, 114, 93, 133, 107), new GenericBox(1, 105, 107, 137, 148), new GenericBox(1, 135, 114, 150, 139), new GenericBox(1, 93, 141, 159, 193) }),            
            new FrameData(114, -7, 0, new List<GenericBox> { new GenericBox(2, 93, 175, 175, 195), new GenericBox(1, 114, 94, 131, 109), new GenericBox(1, 103, 110, 138, 149), new GenericBox(1, 136, 116, 150, 141), new GenericBox(1, 92, 149, 162, 194) }),
            new FrameData(115, -7, 0, new List<GenericBox> { new GenericBox(1, 112, 93, 131, 109), new GenericBox(1, 105, 108, 138, 149), new GenericBox(1, 136, 115, 150, 142), new GenericBox(1, 94, 144, 164, 193), new GenericBox(2, 98, 176, 177, 195) }),        
        };
